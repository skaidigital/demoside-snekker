...
export const InnholdOmOss = () => {
  return (
    <HeroContainerUtenPadding id="om-oss">
      <Layout>
        <Grid>
          <GridItem c="col-span-4 md:col-span-8 lg:col-span-6">
            <h2 className="text-h2 text-cta mb-4">Om oss</h2>
            <p className="mb-8">
              Vi tilbyr alt av betong- og tømrerarbeider, som: Tilbygg, nybygg,
              underbygg, platting, verandaer, påbygg, vann og råteskader,
              modernisering, utskiftninger av utvendig panel, vedlikehold,
              service, restaurering, rehabilitering, forskalingsarbeider, bad og
              kjøkken m.m. Vi er for tiden seks ansatte, hvorav to bygg- og
              tømrermestere, som satser på de beste løsninger for ditt behov,
              til topp kvalitet
            </p>
            <p>
          ...
          <GridItem c="col-span-4 md:col-span-8 lg:col-span-6 grid justify-items-stretch">
            <Bilde
          ...
          <GridItem c="col-span-4 md:col-span-8 lg:col-span-6 lg:col-start-7">
            <div className="mb-8">
              <h2 className="text-cta mb-4">Tømrer</h2>
              <p>
            ...
            <div className="mb-8">
              <h2 className="text-cta mb-4">Entreprenør</h2>
              <p>
            ...
            <div className="mb-8">
              <h2 className="text-cta mb-4">Enterprise</h2>
              <p>
