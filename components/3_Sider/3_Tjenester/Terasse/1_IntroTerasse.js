        ...
        <Layout>
          <Grid>
            <GridItem c="col-span-4 md:col-span-8 lg:col-span-8 lg:col-start-3">
              <h2 className="mb-4">Vi bygger din drømmeterasse</h2>
              <p className="mb-4">
        ...
        <Layout>
          <Grid>
            <GridItem c="col-span-4 md:col-span-8 lg:col-start-3">
              <h2 class="mb-4">Noen ting du må tenke på</h2>
              <p class="font-semibold mb-4">
                Noen viktige ting å tenke gjennom enten du skal gjøre jobben
                selv eller leie inn andre er:
              </p>
              <ul>
